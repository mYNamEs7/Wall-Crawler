...
public class LevelManagerEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        _levelList = new ReorderableList(serializedObject, serializedObject.FindProperty("Levels"), true, true, true, true);
        _levelList.drawElementCallback = (rect, index, _, _) =>
        {
            var element = _levelList.serializedProperty.GetArrayElementAtIndex(index);
        ...
        _levelList.drawHeaderCallback = rect => EditorGUI.LabelField(rect, "Levels");
    }
